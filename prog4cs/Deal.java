...
public class Deal {
	public static void main(String[] args) {
		...
		// declare how many cards per player depending on the game
		// blackjack = 2. poker = 5...
		...
		// multideck blackjack has 6 decks. each deck has 4 suits		
		String[] SUITS = {
		...
		int n = SUITS.length * RANKS.length; // total number of cards 312 = 4 * 13 * 6
